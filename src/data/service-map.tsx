...
export const serviceCategories: ServiceCategory[] = [
  {
    ...
    articles: [
      { slug: "consultation", title: "命理諮詢｜找不到人生方向？18 年經驗幫你理出頭緒", shortTitle: "命理諮詢", contentFile: "consultation.md", image: "/images/blog/consultation.webp" },
      { slug: "financial", title: "財富諮詢｜當努力賺錢卻看不到出路", shortTitle: "財富諮詢", contentFile: "financial.md", image: "/images/blog/financial.webp" },
  ...
  },
  {
    ...
    articles: [
      { slug: "five-nobles", title: "五方貴人法｜為什麼機會總是擦身而過？", shortTitle: "五方貴人法", contentFile: "five-nobles.md", image: "/images/blog/five-nobles.webp" },
      { slug: "five-earth", title: "五方五土招財法｜穩定財源的根基法事", shortTitle: "五方五土招財", contentFile: "five-earth.md", image: "/images/blog/five-earth.webp" },
      { slug: "day-night", title: "日夜招財法｜白天正財、晚上偏財，雙管齊下", shortTitle: "日夜招財", contentFile: "day-night.md", image: "/images/blog/day-night.webp" },
      { slug: "wealth-vault", title: "補財庫法事｜為什麼努力賺錢卻總是留不住？", shortTitle: "補財庫", contentFile: "wealth-vault.md", image: "/images/blog/wealth-vault.webp" },
      { slug: "past-life-debt", title: "還壽生金法事｜前世的帳，會影響今生的財運嗎？", shortTitle: "還壽生金", contentFile: "past-life-debt.md", image: "/images/blog/past-life-debt.webp" },
      { slug: "guanyin", title: "觀音送財符｜求財之前，先把財路打開", shortTitle: "觀音送財符", contentFile: "guanyin.md", image: "/images/blog/guanyin.webp" },
      { slug: "shop-wealth", title: "開店旺財法事｜生意不好，不一定是你不夠努力", shortTitle: "開店旺財", contentFile: "shop-wealth.md", image: "/images/blog/shop-wealth.webp" },
      { slug: "dual-wealth", title: "兩度招財法事｜急需用錢又想長期穩財，可以同時處理嗎？", shortTitle: "兩度招財", contentFile: "dual-wealth.md", image: "/images/blog/dual-wealth.webp" },
    ],
  },
  {
    slug: "shiye",
  ...
  },
  {
    ...
    articles: [
      { slug: "love-recovery", title: "感情挽回法術｜分手後還有機會嗎？法事能做什麼？", shortTitle: "感情挽回", contentFile: "love-recovery.md", image: "/images/blog/love-recovery.webp" },
